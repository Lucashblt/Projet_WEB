...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 10 nov. 2023 à 23:40
...
--
CREATE DATABASE IF NOT EXISTS `hublart_benzzine` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `hublart_benzzine`;
...
(8, 9, '2023-11-07 22:16:54', '11880', 'Carte Bancaire', 'En préparation'),
(9, 9, '2023-11-07 22:18:02', '11880', 'Carte Bancaire', 'En préparation'),
(10, 9, '2023-11-07 22:18:42', '120', 'Carte Bancaire', 'En préparation'),
(11, 9, '2023-11-07 22:20:06', '300', 'Carte Bancaire', 'En préparation'),
(13, 9, '2023-11-07 22:20:45', '50', 'Carte Bancaire', 'En préparation'),
(14, 9, '2023-11-07 22:23:10', '50', 'Carte Bancaire', 'En préparation'),
(21, 9, '2023-11-10 18:11:35', '50', 'Carte Bancaire', 'En préparation'),
(22, 9, '2023-11-09 23:08:41', '150', 'Carte Bancaire', 'En préparation'),
(23, 9, '2023-11-10 23:09:41', '150', 'Carte Bancaire', 'En préparation');
...
--
ALTER TABLE `avis`
  MODIFY `idAvis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `commandeslignes`
  MODIFY `idCommandesLignes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `prixproduit`
  MODIFY `idPrix` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=303;

--
-- AUTO_INCREMENT pour la table `produit`
--
ALTER TABLE `produit`
  MODIFY `idProduit` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
