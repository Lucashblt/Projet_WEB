<?php
    ...
    function getAllProducts($categories, $limit) {
        global $SQLconn; // Utilisez la connexion SQL
    ...
    function getProductById($idProduit){
        ...
        // Requête SQL pour récupérer toutes les informations des produits
        $query = "SELECT p.nom AS productName, p.photoProduit AS productImage,
                p.description AS productDescription, cp.nom AS colors, pp.prixNet AS productPrice,
